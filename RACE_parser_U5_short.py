...
as having the ligated adapter, and the 3' end of U4). If so,
...
gene_3prime = Seq("TTGCTTTGGCAAGGCTA")  # 3'U5 distinguishing
gene_3prime_end = Seq("CTCTACGGAGACTG") # far end of U4 3'
