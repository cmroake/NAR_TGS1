...
as having the ligated adapter, and the 3' end of U4atac). If so,
...
gene_3prime = Seq("CTAGAGCTTTTGCTTTATTT")  # 3'U4atac distinguishing
gene_3prime_end = Seq("ATTTTGGTGCAATTTTTGGAAAAATG") # far end of U4 3'
